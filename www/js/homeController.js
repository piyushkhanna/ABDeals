...
myApp.service("homeService",function($http,$rootScope){
	...
	{		
		...
		{
			return $http.get($rootScope.baseServiceURL + "/getAds.php?sortorder=distanta&limit=" + startingPos + "&dev_id=" + $rootScope.dev_id + "&user_id=" + $rootScope.user_id + "&dev_model=" + $rootScope.dev_model + "&dev_platform=" + $rootScope.dev_platform + "&dev_version=" + $rootScope.dev_version + "&ulat=" + $rootScope.lat + "&ulng=" + $rootScope.lng + "&cntrycode=" + $rootScope.countryCode + "&pkms=50");
		}
		else
		{
			return $http.get($rootScope.baseServiceURL + "/getAds.php?sortorder=start_date&limit=" + startingPos + "&dev_id=" + $rootScope.dev_id + "&user_id=" + $rootScope.user_id + "&dev_model=" + $rootScope.dev_model + "&dev_platform=" + $rootScope.dev_platform + "&dev_version=" + $rootScope.dev_version + "&ulat=" + $rootScope.lat + "&ulng=" + $rootScope.lng + "&cntrycode=" + $rootScope.countryCode + "&getnational=n");
	...
	else
	{
		if($rootScope.fields.homeDealFilter == 0)
		{
			return $http.get($rootScope.baseServiceURL + "/getAds.php?sortorder=distanta&limit=" + startingPos + "&dev_id=" + $rootScope.dev_id + "&user_id=" + $rootScope.user_id + "&ulat=" + $rootScope.lat + "&ulng=" + $rootScope.lng + "&cntrycode=" + $rootScope.countryCode + "&pkms=50&searchtype=l&searchstr="+ srchTxt);
		}
		else
		{
			return $http.get($rootScope.baseServiceURL + "/getAds.php?sortorder=start_date&limit=" + startingPos + "&dev_id=" + $rootScope.dev_id + "&user_id=" + $rootScope.user_id + "&ulat=" + $rootScope.lat + "&ulng=" + $rootScope.lng + "&cntrycode=" + $rootScope.countryCode + "&getnational=n&searchtype=n&searchstr="+ srchTxt);
